...
public class ReceptionistTest
{
    ...
    public void Constructor_WithValidData_ShouldCreateReceptionist()
    {
        ...
        Assert.Equal(0, receptionist.TotalEarnings);
        Assert.Equal(10000, receptionist.Income); // Default income
    }
    ...
    {
        // Arrange
        var receptionist = new Receptionist(_defaultName, _defaultAddress, _defaultPhoneNumber, 12000);
        ...
        Assert.Contains("12000", result); // Income
